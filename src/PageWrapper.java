...
public class PageWrapper implements MouseMotionListener
{
     ...
     */
    public PageWrapper( PDFReader aReader, annotation annoter ) throws IOException
    {
    	this.annoter = annoter;
        reader = aReader;
        pagePanel = new PDFPagePanel(annoter);
    ...
    public void mouseMoved(MouseEvent e)
    {
        ...
        reader.getBottomStatusPanel().getStatusLabel().setText( e.getX() + "," + e.getY()+" lol" );
    }
}
