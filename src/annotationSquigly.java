...
public class annotationSquigly extends annotation{
	
	private String annotation = "annotationSquigly";
	...
	public void ajouterAnnotation(String filename, String docResultPath, float[] pos){
		...
		try {
		    ...
		    PDAnnotationTextMarkup txtMark = new PDAnnotationTextMarkup(PDAnnotationTextMarkup.SUB_TYPE_SQUIGGLY);
